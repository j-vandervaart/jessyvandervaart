<template>
    <section>
        <div class="mainSec">
            ...
            <div id="edu">	
				<h2 class="skillsHdg">Education</h2>
                <div class="eduGroup">
    				<div class="indEdu">
    					<h3 class="schoolName">Fanshawe College</h3>
    					<p class="progName">Interactive Media Specialist</p>
    					<p class="degreeName">Graduate Diploma</p>
    				</div>
    				<div class="indEdu">
    					<h3 class="schoolName">Western University</h3>
    					<p class="progName">Media Studies</p>
    					<p class="degreeName">BA</p>
    				</div>
    				<div class="indEdu">
    					<h3 class="schoolName">Fanshawe College</h3>
    					<p class="progName">Television Broadcasting</p>
    					<p class="degreeName">Diploma</p>
    				</div>
                </div>
            </div>
        </div>
